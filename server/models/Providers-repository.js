class ProvidersRepository {
    ...
    async getProveedorByName(nombre_proveedor) {
        const query = 'SELECT * FROM Proveedores WHERE nombre_proveedor = ?;';
        const params = [nombre_proveedor];
        ...
        try {
            ...
            console.error(
                `Error retrieving supplier with name "${nombre_proveedor}": ${err}`
            );
            throw err;
        }
    }
